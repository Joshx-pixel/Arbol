...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con mucho amor de Joshua";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-04-09T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('9999-06-04T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `El dia q me enamore con solo verte: <b>${days}</b> días<br>` +
      `Dias que se seguire amando: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
